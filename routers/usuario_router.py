...
@router.get("/", status_code=200, summary="Obtiene todos los usuarios", response_model=List[UsuarioResponse])
...
@router.get("/{usuario_id}", status_code=200, summary="Obtiene un usuario por ID", response_model=UsuarioResponse)
...
@router.post("/", status_code=200, summary="Crea un nuevo usuario", response_model=UsuarioResponse)
...
@router.put("/{usuario_id}", status_code=200, summary="Actualiza un usuario existente", response_model=UsuarioResponse)
